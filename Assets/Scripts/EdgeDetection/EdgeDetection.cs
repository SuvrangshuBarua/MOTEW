...
public class EdgeDetection : ScriptableRendererFeature
{
    private class EdgeDetectionPass : ScriptableRenderPass
    {
        ...
        private static int DepthThresholdProperty = Shader.PropertyToID("_DepthThreshold");
        private static int NormalThresholdProperty = Shader.PropertyToID("_NormalThreshold");
        private static int LuminanceThresholdProperty = Shader.PropertyToID("_LuminanceThreshold");
    ...
    public class EdgeDetectionSettings
    {
        ...
        public float luminanceThreshold = 1.5f;
    }
